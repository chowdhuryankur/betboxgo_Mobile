...
<div class="w3-main w3-black" style="margin-left:250px;">
  ...
  <!-- myTop End --> 
  <!-- navegation Start -->
  <?php require_once('include/secondnaveTm.php'); ?>
  <!-- navegation End -->
  <div class="w3-container nopading">
    <?php require('include/tny_manueTm.php'); ?> 
    ...
    <!-- match start -->
    <div class="w3-panel w3-green w3-round-small w3-padding-small"> <a href="runing_offer.php">
      <div class="w3-bar w3-small match nopading">
        <div class="w3-col s8 box"><img src="<?=base_url()?>img/Cricket_Ball.png"> <?=substr($cricket_match->series,0,35)?></div>
      ...
      <div class="w3-bar nopading">
        <div class="w3-col s2">
          <?=live_sign($cricket_match->start_date_time)?>
        </div>
   ...
   <?php if(isset($football)) { $i = 0; foreach($football->result() as $football_match) { ?> 
    <!-- match start -->
    <div class="w3-panel w3-green w3-round-small w3-padding-small">
      <div class="w3-bar w3-small match nopading">
        <div class="w3-col s8 box"><img src="<?=base_url()?>img/soccer_ball.png" > <?=substr($football_match->series,0,35)?></div>
        <div class="w3-col s3 w3-right-align"><?=substr($football_match->title,0,12)?></div>
      ...
      <div class="w3-bar nopading">
        <div class="w3-col s2">
          <?=live_sign($football_match->start_date_time)?>
        </div>
        <div class="w3-col s10 w3-small">
